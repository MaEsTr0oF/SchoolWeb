  ...
  return (
    <div className="relative z-[10] flex items-center justify-center w-full min-h-[250px]">
      ...
      <div className="absolute inset-x-0 mx-auto w-full max-w-[1200px] z-50 p-6 md:p-10 bg-gradient-to-b from-[#CCDDE2] to-[#D9F1E8] rounded-[26.43px]">
        ...
        <p className="text-[18px] mb-6 text-[#333] font-nekstregular text-center max-w-[900px] mx-auto">
          ...
          */}
          <div className="flex  flex-col md:flex-row md:flex-nowrap gap-2.5 w-full justify-center items-center max-w-[900px] mx-auto">
            <input
              ...
              placeholder="Имя"
              required
              className="font-nekstregular h-[50px] px-5 border border-black rounded-full text-base flex-1 min-w-[150px] bg-transparent box-border shadow-sm placeholder-[#555] placeholder-opacity-75 focus:outline-none"
            />
            ...
            <button
              type="submit"
              className="font-nekstregular h-[50px] px-5 bg-[#2a2a2a] text-white text-base font-medium rounded-full min-w-[220px] flex-shrink-0 shadow-md hover:bg-[#444] mt-3 md:mt-0 w-full md:w-auto"
            >
